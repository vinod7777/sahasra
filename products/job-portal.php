...
<head>
    ...
    <title>Job Portal | Sahasra Barath High-Fidelity Enterprise Solutions</title>
    <!-- Google Fonts -->
...
<body class="font-sans text-brand-dark bg-brand-gray antialiased selection:bg-brand-accent selection:text-white" x-data="{ scrolled: false }" @scroll.window="scrolled = (window.pageYOffset > 20)">
            ...
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                ...
                <div class="reveal">
                    ...
                    <h1 class="text-3xl md:text-5xl lg:text-7xl font-heading font-black mb-6 leading-[1.1] tracking-tighter italic uppercase">
                        Job <br/>
                        <span class="gradient-text">Portal Node.</span>
                    </h1>
                    <p class="text-base md:text-lg mb-8 max-w-xl leading-relaxed opacity-70">
                        Connect talent with opportunities through a high-velocity recruitment engine. Our Job Portal solution provides an institutional-grade platform for candidate logic, employer dashboards, and automated hiring funnels.
                    </p>
                    ...
                    <div class="grid sm:grid-cols-2 gap-4 mb-10">
                        <div class="flex items-center gap-3">
                            ...
                            <span class="text-[11px] font-bold feature-label uppercase tracking-widest leading-none">Smart Search</span>
                        </div>
                        <div class="flex items-center gap-3">
                            ...
                            <span class="text-[11px] font-bold feature-label uppercase tracking-widest leading-none">Resume Logic</span>
                        </div>
                        <div class="flex items-center gap-3">
                            <div class="w-8 h-8 rounded-lg bg-brand-accent/10 flex items-center justify-center text-brand-accent"><i class="uil uil-chart-bubble"></i></div>
                            <span class="text-[11px] font-bold feature-label uppercase tracking-widest leading-none">Match Ranking</span>
                        </div>
                        <div class="flex items-center gap-3">
                            ...
                            <span class="text-[11px] font-bold feature-label uppercase tracking-widest leading-none">Global Security</span>
                        </div>
                    </div>
                ...
                <div class="reveal">
                    <div class="glass-form p-6 md:p-8 rounded-[40px] shadow-2xl relative overflow-hidden border border-white/20">
                        ...
                        <div class="flex items-center gap-4 mb-6">
                            ...
                            <div>
                                <h2 class="text-2xl font-black tracking-tight leading-none uppercase italic">Setup Portal</h2>
                                <p class="text-[10px] opacity-60 mt-1.5 font-medium uppercase tracking-wider">Enterprise Recruitment Deployment</p>
                            </div>
                        </div>
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="relative group">
                                    ...
                                    <select class="w-full pl-11 pr-4 py-3.5 border rounded-2xl text-[13px] font-medium appearance-none outline-none focus:ring-2 focus:ring-brand-accent/20 transition-all bg-white/5 dark:bg-black/5">
                                        <option value="">Employer Size</option>
    ...
    <section id="features" class="py-24 theme-aware-hero border-y border-brand-dark/5 dark:border-white/5">
        <div class="container mx-auto px-6 md:px-12">
            <div class="text-center mb-20 reveal">
                <h2 class="text-3xl md:text-5xl font-heading font-black mb-6 tracking-tighter uppercase italic text-brand-accent">Hiring <span class="text-brand-dark dark:text-white">Fidelity</span></h2>
                <p class="text-[11px] opacity-60 uppercase tracking-[4px] font-black max-w-xl mx-auto">The Core Modules of the recruitment Infrastructure</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div class="reveal glass-form sahasra-feature-card p-10 rounded-[40px] hover:border-brand-accent transition-all group cursor-pointer hover:shadow-2xl hover:shadow-brand-accent/5">
                    <div class="w-12 h-12 rounded-2xl bg-brand-accent/10 flex items-center justify-center text-brand-accent mb-6 group-hover:scale-110 transition-transform duration-500">
                        <i class="uil uil-file-search-alt text-2xl"></i>
                    </div>
                    <h4 class="text-lg font-black mb-3 italic uppercase">Resume Parser</h4>
                    <p class="text-[11px] opacity-60 leading-relaxed font-bold tracking-tight">Extract intelligence from resumes instantly with deep-learning logic and zero-stuck parsing.</p>
                </div>
                <div class="reveal glass-form sahasra-feature-card p-10 rounded-[40px] hover:border-border-brand-accent transition-all group cursor-pointer hover:shadow-2xl hover:shadow-brand-accent/5">
                    <div class="w-12 h-12 rounded-2xl bg-brand-accent/10 flex items-center justify-center text-brand-accent mb-6 group-hover:scale-110 transition-transform duration-500">
                        <i class="uil uil-schedule text-2xl"></i>
                    </div>
                    <h4 class="text-lg font-black mb-3 italic uppercase">Interview Ops</h4>
                    <p class="text-[11px] opacity-60 leading-relaxed font-bold tracking-tight">Streamlined scheduling logic that keeps candidates and employers in consistent resonance.</p>
                </div>
                <div class="reveal glass-form sahasra-feature-card p-10 rounded-[40px] hover:border-brand-accent transition-all group cursor-pointer hover:shadow-2xl hover:shadow-brand-accent/5">
                    <div class="w-12 h-12 rounded-2xl bg-brand-accent/10 flex items-center justify-center text-brand-accent mb-6 group-hover:scale-110 transition-transform duration-500">
                        <i class="uil uil-users-alt text-2xl"></i>
                    </div>
                    <h4 class="text-lg font-black mb-3 italic uppercase">Employer Hub</h4>
                    <p class="text-[11px] opacity-60 leading-relaxed font-bold tracking-tight">A cinematic cockpit for companies to manage listings, track candidates, and measure ROI.</p>
                </div>
                <div class="reveal glass-form sahasra-feature-card p-10 rounded-[40px] hover:border-brand-accent transition-all group cursor-pointer hover:shadow-2xl hover:shadow-brand-accent/5">
                    <div class="w-12 h-12 rounded-2xl bg-brand-accent/10 flex items-center justify-center text-brand-accent mb-6 group-hover:scale-110 transition-transform duration-500">
                        <i class="uil uil-bill text-2xl"></i>
                    </div>
                    <h4 class="text-lg font-black mb-3 italic uppercase">Payment Node</h4>
                    <p class="text-[11px] opacity-60 leading-relaxed font-bold tracking-tight">Institutional-grade monetization logic for featured listings and premium employer access.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-24 theme-aware-hero overflow-hidden relative border-b border-brand-dark/5 dark:border-white/5">
        <div class="container mx-auto px-6 md:px-12 relative z-10">
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                <div class="reveal">
                    <h2 class="text-4xl md:text-5xl font-heading font-black mb-8 italic uppercase text-brand-accent">Talent Pipeline <br/><span class="text-brand-dark dark:text-white">Architecture.</span></h2>
                    <div class="space-y-6">
                        <div class="flex gap-4 p-6 rounded-3xl glass-form border border-white/10 hover:border-brand-accent/30 transition-all group">
                            ...
                            <div>
                                <h4 class="text-lg font-black italic uppercase mb-1">Fractal Pattern Matching</h4>
                                <p class="text-xs opacity-60 font-bold leading-relaxed">Neural nodes analyzing 50+ data points per resume to calculate the perfect talent-to-role resonance.</p>
                            </div>
                        </div>
                        <div class="flex gap-4 p-6 rounded-3xl glass-form border border-white/10 hover:border-brand-accent/30 transition-all group">
                            <div class="w-12 h-12 rounded-2xl bg-brand-accent/10 flex items-center justify-center text-brand-accent shrink-0 group-hover:bg-brand-accent group-hover:text-white transition-all duration-500"><i class="uil uil-envelope-shield text-2xl"></i></div>
                            <div>
                                <h4 class="text-lg font-black italic uppercase mb-1">Encrypted Onboarding</h4>
                                <p class="text-xs opacity-60 font-bold leading-relaxed">Secure document clusters that automate the verification and transition of institutional talent.</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="reveal">
                    <div class="relative">
                        ...
                        <img src="https://images.unsplash.com/photo-1586281380349-632531db7ed4?auto=format&fit=crop&w=800&q=80" alt="Job Architecture" class="rounded-[40px] shadow-2xl border border-white/10 grayscale hover:grayscale-0 transition-all duration-700">
                    </div>
                </div>
            </div>
        </div>
