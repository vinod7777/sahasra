...
<head>
    ...
    <title>Google Workspace (G-Suite) for Enterprise | Sahasra Barath Productivity Integration</title>
    <!-- Google Fonts -->
...
<body class="font-sans text-brand-dark bg-brand-gray antialiased selection:bg-brand-accent selection:text-white" x-data="{ scrolled: false }" @scroll.window="scrolled = (window.pageYOffset > 20)">
            ...
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                ...
                <div class="reveal">
                    ...
                    <p class="text-base md:text-lg mb-8 max-w-xl leading-relaxed opacity-70">
                        Modern teams run on Google. We help you migrate, secure, and manage Google Workspace (G-Suite) to create a high-fidelity collaboration environment for your entire organization.
                    </p>
                    ...
                    <div class="grid sm:grid-cols-2 gap-4 mb-10">
                        <div class="flex items-center gap-3">
                            ...
                            <span class="text-xs font-bold feature-label uppercase tracking-widest leading-none">Official Partner</span>
                        </div>
                        <div class="flex items-center gap-3">
                            <div class="w-8 h-8 rounded-lg bg-brand-accent/10 flex items-center justify-center text-brand-accent"><i class="uil uil-cloud-share"></i></div>
                            <span class="text-xs font-bold feature-label uppercase tracking-widest leading-none">Drive Unlimited</span>
                        </div>
                        <div class="flex items-center gap-3">
                            <div class="w-8 h-8 rounded-lg bg-brand-accent/10 flex items-center justify-center text-brand-accent"><i class="uil uil-video"></i></div>
                            <span class="text-xs font-bold feature-label uppercase tracking-widest leading-none">HD Meet</span>
                        </div>
                        <div class="flex items-center gap-3">
                            ...
                            <span class="text-xs font-bold feature-label uppercase tracking-widest leading-none">Data Vaults</span>
                        </div>
                    </div>

                    <div class="flex flex-col sm:flex-row gap-4 items-center">
                        <a href="<?php echo $root; ?>contact.php" class="w-full sm:w-auto px-10 py-5 rounded-2xl border-2 border-brand-accent text-brand-accent font-black uppercase text-[10px] tracking-widest hover:bg-brand-accent hover:text-white transition-all shadow-lg block text-center">The Suite</a>
                        <div class="flex items-center gap-3">
                            <span class="w-3 h-3 rounded-full bg-blue-500 animate-pulse"></span>
                            <span class="text-[10px] font-black uppercase tracking-widest opacity-60">Verified Admin Ops</span>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="relative group">
                                    ...
                                    <select class="w-full pl-11 pr-4 py-3.5 border rounded-2xl text-[13px] font-medium appearance-none outline-none focus:ring-2 focus:ring-brand-accent/20 transition-all">
                                        ...
                                        <option value="business">Workspace Business Starter</option>
                                        <option value="enterprise">Workspace Enterprise</option>
                                        <option value="migration">G-Suite Migration Only</option>
                                        <option value="admin">Managed Admin Support</option>
                                    </select>
    ...
    <!-- 2. WORKSPACE INTELLIGENCE (ECOSYSTEM) -->
    <section id="intelligence" class="py-24 theme-aware-hero border-y border-brand-dark/5 dark:border-white/5">
        <div class="container mx-auto px-6 md:px-12">
            <div class="text-center mb-20 reveal">
                <h2 class="text-3xl md:text-5xl font-heading font-black mb-6 tracking-tighter uppercase italic text-brand-accent">Toolkit <span class="text-brand-dark dark:text-white">Universe</span></h2>
                <p class="text-sm opacity-50 uppercase tracking-widest font-bold max-w-xl mx-auto">Deploying the world's most powerful productivity ecosystem for your enterprise</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="reveal glass-form sahasra-feature-card p-10 rounded-[40px] hover:border-brand-accent transition-all group">
                    ...
                    <h4 class="text-lg font-black mb-3">Google Drive</h4>
                    <p class="text-xs opacity-60 leading-relaxed font-medium">Scalable cloud storage with granular permission controls for every department.</p>
                </div>
                <!-- G2 -->
                <div class="reveal glass-form sahasra-feature-card p-10 rounded-[40px] hover:border-brand-accent transition-all group">
                    <div class="w-12 h-12 rounded-2xl bg-brand-accent/10 flex items-center justify-center text-brand-accent mb-6 group-hover:scale-110 transition-transform">
                        <i class="uil uil-file-bookmark-alt text-2xl"></i>
                    </div>
                    <h4 class="text-lg font-black mb-3">Docs & Sheets</h4>
                    <p class="text-xs opacity-60 leading-relaxed font-medium">Real-time collaborative editing of high-fidelity documents and data architectures.</p>
                </div>
                <!-- G3 -->
                <div class="reveal glass-form sahasra-feature-card p-10 rounded-[40px] hover:border-brand-accent transition-all group">
                    <div class="w-12 h-12 rounded-2xl bg-brand-accent/10 flex items-center justify-center text-brand-accent mb-6 group-hover:scale-110 transition-transform">
                    ...
                    <h4 class="text-lg font-black mb-3">Google Meet</h4>
                    <p class="text-xs opacity-60 leading-relaxed font-medium">Encrypted video conferencing hardware-integrated for boardrooms and remote teams.</p>
                </div>
                <!-- G4 -->
                <div class="reveal glass-form sahasra-feature-card p-10 rounded-[40px] hover:border-brand-accent transition-all group">
                    <div class="w-12 h-12 rounded-2xl bg-brand-accent/10 flex items-center justify-center text-brand-accent mb-6 group-hover:scale-110 transition-transform">
                    ...
                    <h4 class="text-lg font-black mb-3">Google Vault</h4>
                    <p class="text-xs opacity-60 leading-relaxed font-medium">Enterprise data-retention and eDiscovery to ensure legal and brand compliance.</p>
                </div>
                <!-- G5 -->
                <div class="reveal glass-form sahasra-feature-card p-10 rounded-[40px] hover:border-brand-accent transition-all group">
                    <div class="w-12 h-12 rounded-2xl bg-brand-accent/10 flex items-center justify-center text-brand-accent mb-6 group-hover:scale-110 transition-transform">
                    ...
                    <h4 class="text-lg font-black mb-3">Endpoint Control</h4>
                    <p class="text-xs opacity-60 leading-relaxed font-medium">Managing and wiping company data remotely from lost or rogue mobile devices instantly.</p>
                </div>
                <!-- G6 -->
                <div class="reveal glass-form sahasra-feature-card p-10 rounded-[40px] hover:border-brand-accent transition-all group">
                    <div class="w-12 h-12 rounded-2xl bg-brand-accent/10 flex items-center justify-center text-brand-accent mb-6 group-hover:scale-110 transition-transform">
                    ...
                    <h4 class="text-lg font-black mb-3">Directory Sync</h4>
                    <p class="text-xs opacity-60 leading-relaxed font-medium">Automated provisioning of new user accounts synchronized with your core HR database.</p>
                </div>
                <!-- G7 -->
                <div class="reveal glass-form sahasra-feature-card p-10 rounded-[40px] hover:border-brand-accent transition-all group">
                    <div class="w-12 h-12 rounded-2xl bg-brand-accent/10 flex items-center justify-center text-brand-accent mb-6 group-hover:scale-110 transition-transform">
                    ...
                    <h4 class="text-lg font-black mb-3">Marketplace Addons</h4>
                    <p class="text-xs opacity-60 leading-relaxed font-medium">Curating and deploying vetted third-party apps to enhance the base Google functionality.</p>
                </div>
                <!-- G8 -->
                <div class="reveal glass-form sahasra-feature-card p-10 rounded-[40px] hover:border-brand-accent transition-all group">
                    <div class="w-12 h-12 rounded-2xl bg-brand-accent/10 flex items-center justify-center text-brand-accent mb-6 group-hover:scale-110 transition-transform">
                    ...
                    <p class="text-xs opacity-60 leading-relaxed font-medium">End-to-end transfer of files and emails from Outlook or onsite servers into the cloud.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container mx-auto px-6 md:px-12">
            <div class="flex flex-col lg:flex-row justify-between items-end mb-16 gap-6">
                <div class="max-w-2xl reveal">
                    <h2 class="text-4xl md:text-5xl font-heading font-black mb-6 leading-tight uppercase tracking-tighter text-brand-accent">Modern <br><span class="text-brand-dark dark:text-white italic">Velocity.</span></h2>
                    <p class="text-base md:text-lg opacity-60">Success requires frictionless tools. We build the infrastructure that lets your team focus on output, not IT.</p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div class="reveal glass-form sahasra-feature-card p-10 rounded-[40px] border border-white/10 hover:border-brand-accent/30 transition-all group">
                    ...
                    <h4 class="text-xl font-black mb-4">Zero Downtime</h4>
                    <p class="text-sm opacity-60 leading-relaxed">Leveraging Google's global data center network to guarantee your team stays connected 24/7/365.</p>
                </div>
                <div class="reveal glass-form sahasra-feature-card p-10 rounded-[40px] border border-white/10 hover:border-brand-accent/30 transition-all group">
                    <div class="w-14 h-14 rounded-2xl bg-brand-accent/10 flex items-center justify-center text-brand-accent mb-8 group-hover:bg-brand-accent group-hover:text-white transition-all duration-500">
                        <i class="uil uil-university text-3xl"></i>
                    </div>
                    <h4 class="text-xl font-black mb-4">HIPAA Verified</h4>
                    <p class="text-sm opacity-60 leading-relaxed">Configuring Workspace to meet the world's most stringent data privacy and storage standards.</p>
                </div>
                <div class="reveal glass-form sahasra-feature-card p-10 rounded-[40px] border border-white/10 hover:border-brand-accent/30 transition-all group">
                    <div class="w-14 h-14 rounded-2xl bg-brand-accent/10 flex items-center justify-center text-brand-accent mb-8 group-hover:bg-brand-accent group-hover:text-white transition-all duration-500">
                        <i class="uil uil-heart-rate text-3xl"></i>
                    </div>
                    <h4 class="text-xl font-black mb-4">High Performance</h4>
                    <p class="text-sm opacity-60 leading-relaxed">Optimized account setups that eliminate permission bottlenecks and drive collaboration speed.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container mx-auto px-6 md:px-12">
            <div class="max-w-4xl mx-auto">
                <div class="text-center mb-16 reveal">
                    <h2 class="text-3xl md:text-5xl font-heading font-black mb-4 tracking-tight uppercase italic gradient-text">Workspace Intelligence FAQ</h2>
                    <p class="text-base opacity-60 uppercase tracking-widest font-black text-xs">Strategic answers for global operational leaders</p>
                </div>
                ...
                <div class="space-y-4">
                    <details class="reveal group border-b border-brand-dark/5 dark:border-white/10 transition-all hover:bg-brand-accent/[0.02]" open>
                        <summary class="cursor-pointer list-none py-6 px-4 font-bold flex items-center justify-between text-brand-dark dark:text-white">
                            <span class="text-lg md:text-xl pr-6 font-heading tracking-tight uppercase italic">Is this just a group of Gmail accounts?</span>
                        ...
                        <div class="px-4 pb-8 pt-0">
                            <p class="text-base md:text-lg opacity-60 leading-relaxed max-w-3xl">No. Google Workspace is a comprehensive business command center. It provides custom domain emails, advanced admin settings, higher security controls, and specialized business tools not found in free Gmail.</p>
                        </div>
                    </details>
                    <details class="reveal group border-b border-brand-dark/5 dark:border-white/10 transition-all hover:bg-brand-accent/[0.02]">
                        <summary class="cursor-pointer list-none py-6 px-4 font-bold flex items-center justify-between text-brand-dark dark:text-white">
                            <span class="text-lg md:text-xl pr-6 font-heading tracking-tight uppercase italic">Can we migrate from Microsoft 365?</span>
                            <div class="w-10 h-10 rounded-full border border-brand-accent/20 flex items-center justify-center text-brand-accent group-open:bg-brand-accent group-open:text-white group-open:rotate-180 transition-all">
                                <i class="uil uil-angle-down text-2xl"></i>
                            </div>
                        </summary>
                        <div class="px-4 pb-8 pt-0">
                            <p class="text-base md:text-lg opacity-60 leading-relaxed max-w-3xl">Yes. We specialize in cross-cloud migrations. We can transfer all your Outlook emails, OneDrive files, and calendars into Workspace with zero data loss or downtime.</p>
                        </div>
                    </details>
                    <details class="reveal group border-b border-brand-dark/5 dark:border-white/10 transition-all hover:bg-brand-accent/[0.02]">
                        <summary class="cursor-pointer list-none py-6 px-4 font-bold flex items-center justify-between text-brand-dark dark:text-white">
                            <span class="text-lg md:text-xl pr-6 font-heading tracking-tight uppercase italic">How many users can we add?</span>
                            <div class="w-10 h-10 rounded-full border border-brand-accent/20 flex items-center justify-center text-brand-accent group-open:bg-brand-accent group-open:text-white group-open:rotate-180 transition-all">
                                <i class="uil uil-angle-down text-2xl"></i>
                            </div>
                        </summary>
                        <div class="px-4 pb-8 pt-0">
                            <p class="text-base md:text-lg opacity-60 leading-relaxed max-w-3xl">Workspace can scale from 1 to 100,000+ users. It is designed to grow with your organization, and we manage the tiered billing and provisioning as you expand.</p>
                        </div>
                    </details>
                </div>
            </div>
            ...
            <div class="reveal mt-20 rounded-[40px] border border-brand-accent/20 bg-brand-accent/[0.03] p-10 md:p-12 text-center relative overflow-hidden">
                <h3 class="text-3xl md:text-5xl font-heading font-black mb-6 relative z-10 leading-tight uppercase italic gradient-text">Integrate the <br>Google Advantage</h3>
                <div class="flex flex-col sm:flex-row items-center justify-center gap-4 relative z-10">
                    <a href="<?php echo $root; ?>contact.php" class="w-full sm:w-auto px-10 py-5 rounded-2xl gradient-bg text-white font-black text-xs uppercase tracking-widest shadow-2xl hover:scale-105 transition-all block text-center">Provision G-Suite</a>
                </div>
            </div>
        </div>
    </section>
