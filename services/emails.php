...
<head>
    ...
    <title>Professional Email Hub | Sahasra Barath Corporate Connectivity</title>
    <!-- Google Fonts -->
...
<body class="font-sans text-brand-dark bg-brand-gray antialiased selection:bg-brand-accent selection:text-white" x-data="{ scrolled: false }" @scroll.window="scrolled = (window.pageYOffset > 20)">
            ...
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                ...
                <div class="reveal">
                    <h1 class="text-3xl md:text-5xl lg:text-7xl font-heading font-black mb-6 leading-[1.1] tracking-tighter italic uppercase">
                        Absolute <br/>
                        <span class="gradient-text">Correspondence.</span>
                    </h1>
                    <p class="text-base md:text-lg mb-8 max-w-xl leading-relaxed opacity-70">
                        Secure institutional connectivity is the backbone of your brand. We provide tiered email architectures with absolute data privacy, 2-factor security, and global anti-spam protocols.
                    </p>
                    ...
                    <div class="grid sm:grid-cols-2 gap-4 mb-10">
                        <div class="flex items-center gap-3">
                            ...
                            <span class="text-xs font-bold feature-label uppercase tracking-widest leading-none">2-Factor Security</span>
                        </div>
                        <div class="flex items-center gap-3">
                            ...
                            <span class="text-xs font-bold feature-label uppercase tracking-widest leading-none">Spam Protocols</span>
                        </div>
                        <div class="flex items-center gap-3">
                            ...
                            <span class="text-xs font-bold feature-label uppercase tracking-widest leading-none">Cross-Device Hub</span>
                        </div>
                        <div class="flex items-center gap-3">
                            <div class="w-8 h-8 rounded-lg bg-brand-accent/10 flex items-center justify-center text-brand-accent"><i class="uil uil-lock"></i></div>
                            <span class="text-xs font-bold feature-label uppercase tracking-widest leading-none">TLS 1.3 Sync</span>
                        </div>
                    </div>

                    <div class="flex flex-col sm:flex-row gap-4 items-center">
                        <a href="<?php echo $root; ?>contact.php" class="w-full sm:w-auto px-10 py-5 rounded-2xl border-2 border-brand-accent text-brand-accent font-black uppercase text-[10px] tracking-widest hover:bg-brand-accent hover:text-white transition-all shadow-lg block text-center">The Mail Ecosystem</a>
                    </div>
                </div>
                    ...
                    <div class="glass-form p-6 md:p-8 rounded-[40px] shadow-2xl relative overflow-hidden border border-white/20">
                        ...
                        <div class="flex items-center gap-4 mb-6">
                            ...
                            <div>
                                ...
                                <p class="text-[11px] opacity-60 mt-1.5 font-medium uppercase tracking-wider">Secure Communication</p>
                            </div>
                        </div>
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="relative group">
                                    ...
                                    <select class="w-full pl-11 pr-4 py-3.5 border rounded-2xl text-[13px] font-medium appearance-none outline-none focus:ring-2 focus:ring-brand-accent/20 transition-all">
                                        ...
                                        <option value="corporate">Corporate Business Email</option>
                                        <option value="managed">Managed Inbox Hosting</option>
                                        <option value="security">Email Security Audit</option>
                                        <option value="migration">Email Server Migration</option>
                                    </select>
    ...
    <!-- 2. HUB ECOSYSTEM -->
    <section id="hub" class="py-24 theme-aware-hero border-y border-brand-dark/5 dark:border-white/5">
        <div class="container mx-auto px-6 md:px-12">
            <div class="text-center mb-20 reveal">
                <h2 class="text-3xl md:text-5xl font-heading font-black mb-6 tracking-tighter uppercase italic text-brand-accent">Correspondence <span class="text-brand-dark dark:text-white">Universe</span></h2>
                <p class="text-sm opacity-50 uppercase tracking-widest font-bold max-w-xl mx-auto">Deploying institutional-grade mail nodes for global brand authority</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="reveal glass-form sahasra-feature-card p-10 rounded-[40px] hover:border-brand-accent transition-all group">
                    <div class="w-12 h-12 rounded-2xl bg-brand-accent/10 flex items-center justify-center text-brand-accent mb-6 group-hover:scale-110 transition-transform">
                        <i class="uil uil-envelope-lock text-2xl"></i>
                    </div>
                    <h4 class="text-lg font-black mb-3">Secure Nodes</h4>
                    <p class="text-xs opacity-60 leading-relaxed font-medium">Every inbox is shielded by institution-grade encryption and 2FA authentication.</p>
                </div>
                <!-- H2 -->
                <div class="reveal glass-form sahasra-feature-card p-10 rounded-[40px] hover:border-brand-accent transition-all group">
                    <div class="w-12 h-12 rounded-2xl bg-brand-accent/10 flex items-center justify-center text-brand-accent mb-6 group-hover:scale-110 transition-transform">
                    ...
                    <h4 class="text-lg font-black mb-3">Anti-Phish Hub</h4>
                    <p class="text-xs opacity-60 leading-relaxed font-medium">Advanced filtering that identifies and neutralizes malicious signals before they hit the inbox.</p>
                </div>
                <!-- H3 -->
                <div class="reveal glass-form sahasra-feature-card p-10 rounded-[40px] hover:border-brand-accent transition-all group">
                    <div class="w-12 h-12 rounded-2xl bg-brand-accent/10 flex items-center justify-center text-brand-accent mb-6 group-hover:scale-110 transition-transform">
                    ...
                    <h4 class="text-lg font-black mb-3">Real-time Sync</h4>
                    <p class="text-xs opacity-60 leading-relaxed font-medium">Seamless delivery across mobile, tablet, and desktop with low-latency PGP tunneling.</p>
                </div>
                <!-- H4 -->
                <div class="reveal glass-form sahasra-feature-card p-10 rounded-[40px] hover:border-brand-accent transition-all group">
                    <div class="w-12 h-12 rounded-2xl bg-brand-accent/10 flex items-center justify-center text-brand-accent mb-6 group-hover:scale-110 transition-transform">
                    ...
                    <h4 class="text-lg font-black mb-3">Dedicated IP</h4>
                    <p class="text-xs opacity-60 leading-relaxed font-medium">Preserving your sender reputation with high-fidelity dedicated mail IPs that prevent spam flags.</p>
                </div>
                <!-- H5 -->
                <div class="reveal glass-form sahasra-feature-card p-10 rounded-[40px] hover:border-brand-accent transition-all group">
                    <div class="w-12 h-12 rounded-2xl bg-brand-accent/10 flex items-center justify-center text-brand-accent mb-6 group-hover:scale-110 transition-transform">
                    ...
                    <p class="text-xs opacity-60 leading-relaxed font-medium">Configuring info@ and support@ aliases with collaborative task tracking features.</p>
                </div>
                <!-- H6 -->
                <div class="reveal glass-form sahasra-feature-card p-10 rounded-[40px] hover:border-brand-accent transition-all group">
                    <div class="w-12 h-12 rounded-2xl bg-brand-accent/10 flex items-center justify-center text-brand-accent mb-6 group-hover:scale-110 transition-transform">
                        <i class="uil uil-expand-arrows text-2xl"></i>
                    </div>
                    <h4 class="text-lg font-black mb-3">Modular Scale</h4>
                    <p class="text-xs opacity-60 leading-relaxed font-medium">Adding or removing users instantly with our responsive cloud command center.</p>
                </div>
                <!-- H7 -->
                <div class="reveal glass-form sahasra-feature-card p-10 rounded-[40px] hover:border-brand-accent transition-all group">
                    <div class="w-12 h-12 rounded-2xl bg-brand-accent/10 flex items-center justify-center text-brand-accent mb-6 group-hover:scale-110 transition-transform">
                    ...
                    <h4 class="text-lg font-black mb-3">Auto Archive</h4>
                    <p class="text-xs opacity-60 leading-relaxed font-medium">Institutional-grade backups that ensure your communication history is never lost or corrupted.</p>
                </div>
                <!-- H8 -->
                <div class="reveal glass-form sahasra-feature-card p-10 rounded-[40px] hover:border-brand-accent transition-all group">
                    <div class="w-12 h-12 rounded-2xl bg-brand-accent/10 flex items-center justify-center text-brand-accent mb-6 group-hover:scale-110 transition-transform">
                    ...
                    <h4 class="text-lg font-black mb-3">Live Response</h4>
                    <p class="text-xs opacity-60 leading-relaxed font-medium">24/7 dedicated support for configuration, migration, and troubleshooting ops.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container mx-auto px-6 md:px-12">
            <div class="flex flex-col lg:flex-row justify-between items-end mb-16 gap-6">
                <div class="max-w-2xl reveal">
                    <h2 class="text-4xl md:text-5xl font-heading font-black mb-6 leading-tight uppercase tracking-tighter text-brand-accent">Corporate <br><span class="text-brand-dark dark:text-white italic">Fidelity.</span></h2>
                    <p class="text-base md:text-lg opacity-60">Your communication stack is your digital handshake. We ensure it's as professional as your firm.</p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div class="reveal glass-form sahasra-feature-card p-10 rounded-[40px] border border-white/10 hover:border-brand-accent/30 transition-all group">
                    ...
                    <h4 class="text-xl font-black mb-4">Identity Guard</h4>
                    <p class="text-sm opacity-60 leading-relaxed">Protecting your domain from spoofing via strategic SPF, DKIM, and DMARC record management.</p>
                </div>
                <div class="reveal glass-form sahasra-feature-card p-10 rounded-[40px] border border-white/10 hover:border-brand-accent/30 transition-all group">
                    <div class="w-14 h-14 rounded-2xl bg-brand-accent/10 flex items-center justify-center text-brand-accent mb-8 group-hover:bg-brand-accent group-hover:text-white transition-all duration-500">
                        <i class="uil uil-shield-exclamation text-3xl"></i>
                    </div>
                    <h4 class="text-xl font-black mb-4">Zero Trust Arch</h4>
                    <p class="text-xs font-black mb-4 uppercase tracking-widest opacity-40">Zero Trust Arch</h4>
                    <p class="text-sm opacity-60 leading-relaxed">Implementing a multi-layer security model that assumes no connection is safe without verification.</p>
                </div>
                <div class="reveal glass-form sahasra-feature-card p-10 rounded-[40px] border border-white/10 hover:border-brand-accent/30 transition-all group">
                    <div class="w-14 h-14 rounded-2xl bg-brand-accent/10 flex items-center justify-center text-brand-accent mb-8 group-hover:bg-brand-accent group-hover:text-white transition-all duration-500">
                        <i class="uil uil-tachometer-fast-alt text-3xl"></i>
                    </div>
                    <h4 class="text-xl font-black mb-4">Inbox Speed</h4>
                    <p class="text-sm opacity-60 leading-relaxed">High-performance nodes ensure your emails are sent and received with sub-millisecond pings.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container mx-auto px-6 md:px-12">
            <div class="max-w-4xl mx-auto">
                <div class="text-center mb-16 reveal">
                    <h2 class="text-3xl md:text-5xl font-heading font-black mb-4 tracking-tight uppercase italic gradient-text">Correspondence FAQ</h2>
                    <p class="text-base opacity-60 uppercase tracking-widest font-black text-xs">Strategic answers for global corporate leaders</p>
                </div>
                ...
                <div class="space-y-4">
                    <details class="reveal group border-b border-brand-dark/5 dark:border-white/10 transition-all hover:bg-brand-accent/[0.02]" open>
                        <summary class="cursor-pointer list-none py-6 px-4 font-bold flex items-center justify-between text-brand-dark dark:text-white">
                            <span class="text-lg md:text-xl pr-6 font-heading tracking-tight uppercase italic">Is this different from Business Emails?</span>
                        ...
                        <div class="px-4 pb-8 pt-0">
                            <p class="text-base md:text-lg opacity-60 leading-relaxed max-w-3xl">This is our core communication portal. Business Emails focus on custom domain branding, while this Hub focus on institution-wide secure connectivity and infrastructure.</p>
                        </div>
                    </details>
                    <details class="reveal group border-b border-brand-dark/5 dark:border-white/10 transition-all hover:bg-brand-accent/[0.02]">
                        <summary class="cursor-pointer list-none py-6 px-4 font-bold flex items-center justify-between text-brand-dark dark:text-white">
                            <span class="text-lg md:text-xl pr-6 font-heading tracking-tight uppercase italic">Can I use Outlook?</span>
                            <div class="w-10 h-10 rounded-full border border-brand-accent/20 flex items-center justify-center text-brand-accent group-open:bg-brand-accent group-open:text-white group-open:rotate-180 transition-all">
                                <i class="uil uil-angle-down text-2xl"></i>
                            </div>
                        </summary>
                        <div class="px-4 pb-8 pt-0">
                            <p class="text-base md:text-lg opacity-60 leading-relaxed max-w-3xl">Yes. Our Hub supports native SMTP/IMAP protocols, ensuring full compatibility with Outlook, Apple Mail, and Android clients.</p>
                        </div>
                    </details>
                    <details class="reveal group border-b border-brand-dark/5 dark:border-white/10 transition-all hover:bg-brand-accent/[0.02]">
                        <summary class="cursor-pointer list-none py-6 px-4 font-bold flex items-center justify-between text-brand-dark dark:text-white">
                            <span class="text-lg md:text-xl pr-6 font-heading tracking-tight uppercase italic">Is my data private?</span>
                            <div class="w-10 h-10 rounded-full border border-brand-accent/20 flex items-center justify-center text-brand-accent group-open:bg-brand-accent group-open:text-white group-open:rotate-180 transition-all">
                                <i class="uil uil-angle-down text-2xl"></i>
                            </div>
                        </summary>
                        <div class="px-4 pb-8 pt-0">
                            <p class="text-base md:text-lg opacity-60 leading-relaxed max-w-3xl">Absolute privacy is our baseline. All data is encrypted in transit and at rest, and we never scan your inbox for advertising data.</p>
                        </div>
                    </details>
                </div>
            </div>
            ...
            <div class="reveal mt-20 rounded-[40px] border border-brand-accent/20 bg-brand-accent/[0.03] p-10 md:p-12 text-center relative overflow-hidden">
                <h3 class="text-3xl md:text-5xl font-heading font-black mb-6 relative z-10 leading-tight uppercase italic gradient-text">Initialize Your <br>Secure Network</h3>
                <div class="flex flex-col sm:flex-row items-center justify-center gap-4 relative z-10">
                    <a href="<?php echo $root; ?>contact.php" class="w-full sm:w-auto px-10 py-5 rounded-2xl gradient-bg text-white font-black text-xs uppercase tracking-widest shadow-2xl hover:scale-105 transition-all block text-center">Setup Hub</a>
                </div>
            </div>
        </div>
    </section>
